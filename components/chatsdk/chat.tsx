...
import { fetcher, fetchWithErrorHandlers, generateUUID } from "@/lib/chatsdk/utils";
...
export function Chat({
  ...
  return (
    <>
      <div style={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0, overflow: "hidden", background: "var(--j-bg)" }}>
        <ChatHeader
          chatId={id}
